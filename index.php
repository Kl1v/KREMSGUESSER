...
<body>
    ...
    <div class="text-center">
        <input type="number" id="userGuess" class="mb-4" placeholder="Gib deinen Wert ein"><br>
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" id="guessButton" disabled>
            Guess
        </button>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <button type="button" class="btn btn-secondary reload-page" data-bs-dismiss="modal">Abbrechen</button>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#guessButton').click(function() {
                ...
                var x = 5 * (random - userGuess);
                if (x < 0) x = x * (-1);
                var score = Math.abs(1000 - x);
